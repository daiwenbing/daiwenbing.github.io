...
(function($,window){
    ...
    DW.music = function(options) {
        var musicValue = {
            ...
            musicType:              ['纯音乐','华语','欧美','霉霉','电音','韩国','爱乐之城'],         //音乐的类型  （需要随机显示）这是结合我自己后台数据库使用的 如果不是用ajax请求是不会显示这个类型的;
            source:                 [
                                        {
                                            name:'告白气球',
                                            singer:'周杰伦',
                                            url:'http:\/\/oiq8j9er1.bkt.clouddn.com\/周杰伦 - 告白气球1.mp3',
                                            img_url:'http://www.daiwei.org//index//music//musicImg//%E5%91%A8%E6%9D%B0%E4%BC%A6-%E5%91%8A%E7%99%BD%E6%B0%94%E7%90%83.jpg',
                                        },{
                                            name:'Fade',
                                            singer:'Alan Walker',
                                            url:'http:\/\/oiq8j9er1.bkt.clouddn.com\/Alan Walker - Faded1.mp3',
                                            img_url:'http:\/\/www.daiwei.org\/index\/music\/musicImg\/Faded.jpg',
                                        },{
                                            name:'你的爱',
                                            singer:'王力宏',
                                            url:'http:\/\/oiq8j9er1.bkt.clouddn.com\/王力宏 - 你的爱1.mp3',
                                            img_url:'http:\/\/www.daiwei.org\/index\/music\/musicImg\/王力宏-你的爱.jpg'
                                        },{
                                            name:'Such',
                                            singer:'姜贤敏,赵贤雅',
                                            url:'http:\/\/oiq8j9er1.bkt.clouddn.com\/姜贤敏,赵贤雅 - Such1.mp3',
